                            ...
                            <div class="form-group">
                              <label class="form-label">Phone Number<span style="color:red;" >*</span></label>
                                <div class="input-group input-group-outline mb-3">
                                    <input type="text" required class="form-control" name="phone_no" required data-parsley-error-message="Please enter valid contact number." data-parsley-pattern="^[0-9 .]+$" maxlength="10">
                                  </div>
                            </div>
                        </div>
                    </div>
                      ...
                      <div class="col-md-8">
                          <div class="form-group">
                            <label class="form-label">Email</label><span style="color:red;" >*</span>
                              <div class="input-group input-group-outline mb-3">
                                <input type="email" required class="form-control" name="email" required data-parsley-error-message="Please enter valid email.">
                              </div>
                          </div>
                      </div>
                  </div>
