                          ...
                          <div class="col-md-6">
                              <div class="form-group">
                                <label class="form-label">City</label><span style="color:red;" >*</span>
                                  <div class="input-group input-group-outline mb-3">
                                      <select class="form-control" readonly id="city_id" name="city_id" data-parsley-error-message="Please select city." required="true">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                              <label class="form-label">Shop Name<span style="color:red;" >*</span></label>
                                <div class="input-group input-group-outline mb-3">
                                    <input type="text" required class="form-control" readonly value="{{ $data->shop_name }}" name="shop_name" required data-parsley-error-message="Please enter valid shop name." data-parsley-pattern="^[A-Z a-z 0-9 .]+$">
                                  </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                              <label class="form-label">Mobile Number 1<span style="color:red;" >*</span></label>
                                <div class="input-group input-group-outline mb-3">
                                    <input type="text" required class="form-control" readonly value="{{ $data->mobile_no1 }}" name="mobile_no1" required data-parsley-error-message="Please enter valid contact number." data-parsley-pattern="^[0-9 .]+$" maxlength="10">
                                  </div>
                            </div>
                        </div>
                    </div>
                      ...
                      <div class="col-md-8">
                          <div class="form-group">
                            <label class="form-label">Mobile Number 2<span style="color:red;" >*</span></label>
                              <div class="input-group input-group-outline mb-3">
                                  <input type="text" required class="form-control" readonly value="{{ $data->mobile_no2 }}" name="mobile_no2" required data-parsley-error-message="Please enter valid contact number." data-parsley-pattern="^[0-9 .]+$" maxlength="10">
                                </div>
                          </div>
                      </div>
                  </div>
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                              <label class="form-label">Address<span style="color:red;" >*</span></label>
                                <div class="input-group input-group-outline mb-3">
                                    <textarea  class="form-control" readonly name="address" required>{{ $data->address }}</textarea>
                                  </div>
                            </div>
                        </div>
                    </div>
                      ...
                      <div class="col-md-8">
                          <div class="form-group">
                            <label class="form-label">Map Link<span style="color:red;" >*</span></label>
                              <div class="input-group input-group-outline mb-3">
                                <input type="text" required class="form-control" readonly value="{{ $data->link }}" name="link" required data-parsley-error-message="Please enter valid link.">
                              </div>
                          </div>
                      </div>
                  </div>
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                          <label class="form-label">Longitude<span style="color:red;" >*</span></label>
                            <div class="input-group input-group-outline mb-3">
                              <input type="text" required class="form-control" readonly value="{{ $data->long }}" name="long" required data-parsley-error-message="Please enter valid contact Longitude." data-parsley-pattern="^[0-9 .]+$">
                              </div>
                        </div>
                    </div>
                </div> --}}
                    <div class="box-footer">
                      <a href="{{url('/')}}/manage_location" type="submit" class="btn btn-primary pull-right">Back</a>
                  </div>
                  </form>
            </div>
          </div>
