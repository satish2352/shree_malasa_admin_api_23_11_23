              ...
              <form action="{{ url('/')}}/update_{{$url_slug}}/{{$data['id']}}" method="post" role="form" data-parsley-validate="parsley" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="row">
                      ...
                      <div class="form-group">
                        <label class="form-label">Title</label><span style="color:red;" >*</span>
                          <div class="input-group input-group-outline mb-3">
                              <input type="text" class="form-control" name="title"  value="{{ $data['title'] }}" readonly data-parsley-error-message="Please enter valid title." data-parsley-pattern="^[a-z A-Z .]+$" required="true">
                            </div>
                      </div>
                  </div>
              </div>
                  ...
                  <div class="box-footer">
                    <a href="{{url('/')}}/manage_quicklinks" type="submit" class="btn btn-primary pull-right">Back</a>
                </div>
                  </form>
            </div>
          </div>
