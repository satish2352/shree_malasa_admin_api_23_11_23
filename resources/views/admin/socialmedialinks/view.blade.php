                      ...
                      <div class="form-group">
                        <label class="form-label">Title</label><span style="color:red;" >*</span>
                          <div class="input-group input-group-outline mb-3">
                              <input type="text" class="form-control" value="{{ $data['title'] }}" readonly name="title"  data-parsley-error-message="Please enter valid title." data-parsley-pattern="^[a-z A-Z .]+$" required="true">
                            </div>
                      </div>
                  </div>
              </div>
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                              <label class="form-label">Link</label>
                                <div class="input-group input-group-outline mb-3">
                                    <input type="text" class="form-control" readonly name="link"  value="{{$data['link']}}">
                                  </div>
                            </div>
                        </div>
                    </div>
                  <div class="box-footer">
                    <a href="{{url('/')}}/manage_socialmedialinks" type="submit" class="btn btn-primary pull-right">Back</a>
                </div>
                  </form>
            </div>
          </div>
