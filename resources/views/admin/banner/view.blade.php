              ...
              <form action="{{ url('/')}}/update_{{$url_slug}}/{{ $data->id }}" method="post" role="form" data-parsley-validate="parsley" enctype="multipart/form-data" autocomplete="off">
                      ...
                      <div class="form-group">
                        <label class="form-label">Main Category</label><span style="color:red;" >*</span>
                          <div class="input-group input-group-outline mb-3">
                              <select class="form-control" readonly id="main_category" name="main_category" data-parsley-error-message="Please select main category." required="true">
                ...
                <div class="row">
                    ...
                    <div class="box-footer">
                      <a href="{{url('/')}}/manage_banner" type="submit" class="btn btn-primary pull-right">Back</a>
                  </div>
                </form>
            </div>
          </div>
